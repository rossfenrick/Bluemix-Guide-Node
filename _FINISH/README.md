...
$ cd _START
(The _START folder has everything that you need to complete this guide)
(The _FINISH folder has the completion of application)
```
...
###2.2 Run the app locally and store To-do’s to Cloudant
...
###2.3 Deploy your app to Bluemix
...
####2.3.1 Modify the code to use VCAP services
Comment out the code in which we hard code the database credentials and uncomment the VCAP service function.
