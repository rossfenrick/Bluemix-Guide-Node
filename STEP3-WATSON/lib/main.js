  ...
  getCloudant = function() {
    ...
    //For Local development, using Cloudant on Bluemix for your Database, we need to the specify database credentials
    ...
    /*
     // When pushing code to Bluemix - best practice not to hard code any database credentials
       url = appEnv.getServiceURL(DatabaseName,
       {
          pathname: "database",
